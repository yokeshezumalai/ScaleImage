package com.yokesh.scalezoomimage;
...
public class ScaleImage extends AppCompatImageView implements View.OnTouchListener {
    ...
    public ScaleImage(Context context, AttributeSet attr) {
        super(context, attr);
